    ...
    return (
        <div className="container px-20 py-16">
            <div className="flex rounded-lg overflow-hidden">
                ...
                <div className="flex-1 w-50% bg-gray-100 px-24 py-20 flex justify-center items-center">
                    <div>
                        <h2 className="text-4xl font-bold text-gray-0 mb-4">Do you have a service to offer?</h2>
                        <p>All your payments are protected by a highly secure Escrow account. Pay in advance or on completion. with just a few clicks of a button, whenever.</p>
