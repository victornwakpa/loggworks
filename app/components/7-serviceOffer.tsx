        ...
        <div className="container px-5 lg:px-20 py-16">
            <div className="flex flex-col-reverse lg:flex-row-reverse rounded-lg overflow-hidden">
                ...
                <div className="flex-1 lg:w-1/2 bg-gray-100 px-5 lg:px-24 py-10 lg:py-20 flex justify-center items-center">
                    <div>
                        <h2 className="text-2xl lg:text-4xl font-bold text-gray-0 mb-4">Can’t find the professional you are looking for??</h2>
                        ...
                        <Button className="bg-primary-20 w-full lg:w-fit mt-8 px-10 py-6">Post a Job</Button>
                    </div>
                </div>
            </div>
        </div>
